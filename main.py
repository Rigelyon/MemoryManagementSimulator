...
class MemoryManagementApp:
    ...
    def create_ui(self):
        ...
        process_label = ctk.CTkLabel(process_frame, text="Process Creation:", 
                                   font=ctk.CTkFont(weight="bold"))
        ...
        time_entry = ctk.CTkEntry(process_inputs_frame, textvariable=self.process_time_var, width=150)
        ...
        algo_dropdown = ctk.CTkOptionMenu(process_inputs_frame, values=algorithms, variable=self.algorithm_var)
